...
<body id="index">
    ...
    <div class="fundo">
        ...
        <div class="text-center text-white legenda">
            <h1>Começe</h1>
            <h4>Inicie já o seu marketing empresarial</h4><br>
    ...
    <div class="fusion1 row m-0">
            ...
            <h2 class="color1"><i>Serviços</i></h2>
            <h4>Procure por empresas que possam<br>oferecer recursos e serviços</h4>
        </div>
    </div>
    <div class="fusion2 row m-0">
            <div class="text-center z2">
                <h2 class="color2"><i>Negocios</i></h2>
                <h4 class="text-white">Venda seu produto e agende reuniões<br>com seus parceiros empresariais</h4>
            </div>
    ...
    <div class="info row m-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Agende reuniões ou encontros quando você quiser.</p>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">eRealtion contém um sistema de entrega completo e seguro.</p>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Receba notificações e fique por dentro do que acontece com sua empresa.</p>
            </div>
        </div>
    </div>
