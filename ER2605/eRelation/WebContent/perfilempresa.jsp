               ...
               <form action="mensagem.jsp" method="POST">
				...
				%>
							<form method="POST" action="servlet">
                				...
                				<button class="solicitacao" title="Aceitar solicitação"><i class="fas fa-user-check"></i></button>
							</form>
							<%
							}
							%>
							<form method="POST" action="servlet">
							 	...
							 	<input name='cnpjDest' value='<%= request.getParameter("cnpj")%>' type='hidden'>
							 	<button class="solicitacao" title="Recusar solicitação"><i class="fas fa-user-times"></i></button>
							</form>
                            ...
                            <%
								if (obj.has("descricao")) {
									if(!obj.getString("descricao").equals(""))
										...
										out.println("Não há nenhuma descrição para a empresa<br>");
								} else {
									out.println("Não há nenhuma descrição para a empresa<br>");
								}
							%>
            ...
            <div class="col-10 col-lg-4">
                ...
                <div class="letter details">
                    <div class="letter-body">
                        <ul>
                            <li>
                                <span class="description">Quantidade de solicitações</span>
