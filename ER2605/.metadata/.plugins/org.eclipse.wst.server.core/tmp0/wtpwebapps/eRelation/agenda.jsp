    ...
    <%}  else { %>
		<div class="empty">
			...
			<div class="empty-body">
				<h1>Ops!</h1>
				<p>
					Parece que você não possui nenhum evento para visualizar.
				</p>
				<span class="obs">
					Obs.: Aqui você poserá ver seus compromissos e eventos. Você poderá agendar uma encontro com qualquer empresa, basta acessar o perfil dela.
				</span>
				<a href="socios.jsp" class="empty-button">Agendar com algum sócio</a>
				<a href="home.jsp" class="empty-button">Agendar com outras empresas</a>
			</div>
		</div>
	<%	}
	} else {
