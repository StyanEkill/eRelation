...
<body>
						...
						<div class="card-body">
							...
							<div class="group">
								...
								<form method="POST" action="servlet">
									...
									<button class="btn btn-danger d-center">Deixar de ser sócio</button>
								</form>
							</div>
						</div>
					</div>
	...
	<div class="empty">
		...
		<div class="empty-body">
			<h1>Ops!</h1>
			<p>
				Parece que sua empresa não possui sócios.
			</p>
			<span class="obs">
				Obs.: Você pode enviar um convite para uma empresa ou aceitar um convite de outra. Você pode ver novos convites na pagina de solicitações.
			</span>
			<a href="solicitacoes.jsp" class="empty-button">Ver solicitações</a>
